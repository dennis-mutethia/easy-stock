...
class Stock():
    def __init__(self, id, product_id, name, category_name, yesterday_opening, yesterday_additions, opening, additions, selling_price, purchase_price):
        ...
        self.yesterday_opening = 0 if yesterday_opening is None else yesterday_opening
        self.yesterday_additions = 0 if yesterday_additions is None else yesterday_additions
        self.opening = 0 if opening is None else opening
        self.additions = 0 if additions is None else additions
        self.selling_price = 0 if selling_price is None else selling_price
        self.purchase_price = 0 if purchase_price is None else purchase_price
